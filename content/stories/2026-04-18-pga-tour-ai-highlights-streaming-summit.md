...
category: "floor"
tags: ["ai", "sports", "streaming", "production"]
source_urls:
  - "https://nabstreamingsummit.com/sessions"
companies: ["PGA TOUR", "Amazon Prime Video", "DAZN", "Warner Bros. Discovery", "NASCAR"]
excerpt: "A Streaming Summit session on April 20 reveals how the PGA TOUR's AI pipeline produces 7,000 short-form highlight clips per week from live tournament coverage."
---

A session at the [NAB Streaming Summit](https://nabstreamingsummit.com/sessions) on April 20, titled "Millions of Fans, 7,000 AI Highlight Clips a Week: Inside the PGA TOUR's Video Playbook," will detail how the PGA TOUR uses an AI-driven pipeline to produce 7,000 short-form highlight clips weekly from live tournament coverage. The volume — roughly 1,000 clips per tournament day across concurrent events — represents one of the most concrete production-scale deployments of AI clip generation in sports media to date.
