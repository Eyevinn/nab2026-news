---
title: "SNS launches Outpost review platform, AI Suite, and Trio cloud storage"
slug: "sns-outpost-ai-suite-trio-storage"
date: "2026-04-20T15:10:00Z"
category: "floor"
tags: ["storage", "cloud", "ai", "production"]
source_urls:
...
The third announcement, AI Suite, is an on-premise perpetual-license platform covering facial recognition, logo detection, semantic search, smart transcription across 90-plus languages, and metadata extraction with unlimited processing hours. Running on-premise rather than in the cloud gives SNS customers with data-governance requirements or bandwidth constraints a path to AI-assisted asset management without sending footage to an external service.

SNS also released EVO OS v7.1.1, a maintenance update with security and performance improvements for existing EVO storage systems. The pricing across all three products is notably concrete at a show where many vendors announce capabilities without attached price points, giving buyers a direct comparison anchor against competing platforms.
